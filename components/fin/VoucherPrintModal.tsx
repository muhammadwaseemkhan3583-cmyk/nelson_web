  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 print-modal-container">
      ...
      <div className="relative bg-gray-100 rounded-3xl shadow-2xl w-full max-w-5xl h-[90vh] overflow-auto flex flex-col p-12 print:p-0 print:bg-white animate-slideUp print:overflow-visible">
        ...
        {/* The Voucher Area */}
        <div id="print-area" className="mx-auto w-[210mm] h-[148.5mm] bg-white p-6 shadow-2xl print:shadow-none relative text-gray-900 border-2 border-dashed border-gray-200 print:border-none print:m-0">
          <div className="border-2 border-gray-900 p-6 flex flex-col h-full relative box-border">
            ...
            {/* Table */}
            <div className="flex-grow overflow-hidden text-gray-900">
              <table className="w-full border-collapse border-2 border-gray-900 text-[11px]">
                ...
                <tbody className="font-bold">
                  {voucher.items.map((item: any) => (
                    <tr key={item.srNo} className="h-8">
                      ...
                      <td className="border-2 border-gray-900 px-2 py-0.5 text-[9px] italic text-gray-500 font-normal leading-tight">{item.remarks}</td>
                    </tr>
                  ))}
                  <tr className="h-8"><td className="border-2 border-gray-900"></td><td className="border-2 border-gray-900"></td><td className="border-2 border-gray-900"></td><td className="border-2 border-gray-900"></td></tr>
                </tbody>
                <tfoot>
            ...
            {/* Amount in Words */}
            <div className="mt-3 mb-6 flex items-center gap-2 border-b border-dashed border-gray-300 pb-1 text-gray-900">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        @media print {
          ...
          /* Show ONLY the modal container and the voucher area */
          ...
          /* Position the voucher area perfectly on the print page */
          #print-area {
